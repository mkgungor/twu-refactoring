...
public class DateParserTest {
    @Test
    public void should_throw_exception_if_year_string_can_not_be_parsed() {
        try {
    ...
    @Test
    public void should_throw_exception_if_month_string_can_not_be_parsed() {
        try {
    ...
    @Test
    public void should_throw_exception_if_date_string_can_not_be_parsed() {
        try {
    ...
    @Test
    public void should_throw_exception_if_hour_string_can_not_be_parsed() {
        try {
    ...
    @Test
    public void should_throw_exception_if_minute_string_can_not_be_parsed() {
        try {
